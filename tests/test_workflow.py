...
class WorkflowTests(unittest.TestCase):
    ...
    def test_promised_history_backup_keeps_private_feature_offline(self):
        ...
        obj.save_revision(core, bare, baseline, "refs/heads/snapshots/baseline")
        (core / "file").write_text("private feature")
        lab.git(core, "commit", "-am", "experiment")
        feature = lab.git(core, "rev-parse", "HEAD")
        obj.save_revision(core, bare, feature, "refs/heads/research/a13/prototype")
        self.assertEqual(lab.git(bare, "show", feature + ":file"), "private feature")
